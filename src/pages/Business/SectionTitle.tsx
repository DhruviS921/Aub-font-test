...
const SectionTitle = () => {
  return (
    <div className="px-12 w-[60%] gap-3 flex flex-col">
      ...
      <p className="text-paragraph font-book">
        Our ecosystem of design, engineering, branding, and business experts
        serves as your partner.
      </p>
      <Button buttonText="Case Studies" endIcon={<SvgArrowRight stroke="#524FF4" />} className="text-white text-paragraph-cta mt-2 font-book" />
    </div>
  );
};
