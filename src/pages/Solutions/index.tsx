    ...
    <div className="px-6 grid grid-cols-2">
      ...
      <div className="flex flex-col gap-15 p-6">
        <div className="flex flex-col gap-3">
          ...
          <p className="w-[80%] text-paragraph-cta text-gray font-book leading-9">
          ...
          <div className="w-[50%] flex gap-4 font-book text-purple text-small-para-cta">
        ...
        <Button
          ...
          className="text-purple font-book !px-0 !py-0 w-fit text-paragraph-cta"
